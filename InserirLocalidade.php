...
<form name ="form_ins_prod" id="Form_ins_prod" action="InserirLocalidade.php" method="post">

<div class="mt-3"> <label>Localidade:</label>  <input type="text" name="localidade" class="input w-full rounded-full border mt-2" placeholder="">  </div>
<br>
...
<?php
    if (isset($_POST["localidade"]))
    {
        ...
        $query = mysqli_query($link, "insert into localidade(localidade) values ('$flocalidade')");
