...
<form name ="form_ins_prod" id="Form_ins_prod" action="InserirCategoria.php" method="post">
...
<?php
    if(isset($_POST["nomec"]))
    {
        ...
        $query = mysqli_query($link, "insert into categorias(designacao) values ('$fnome')");
