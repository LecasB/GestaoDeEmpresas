						...
						<div class="intro-y box  ">
                            <div class="intro-y flex items-center h-10">
                                <h2 class="text-lg font-medium truncate mr-5">
                                    ...
                                    Inserir Produto: <i data-feather="edit-3"></i>
                                </h2>
...
<form name ="form_ins_prod" id="Form_ins_prod" action="InserirProduto.php" method="post">

<div class="mt-3"> <label>Nome:</label>  <input type="text" name="nomep" class="input w-full rounded-full border mt-2" placeholder="">  </div>
<div class="mt-3"> <label>Quantidade:</label>  <input type="text" name="quantidade" class="input w-full rounded-full border mt-2" placeholder="">  </div>
     
<div class="mt-3"> <label>Preço/Unidade:</label>  <input type="text" name="precounidade" class="input w-full rounded-full border mt-2" placeholder="">  </div>
<div class="mt-3"> <label>Categoria:</label> <div class="mt-2"> <select class="input border mr-2" name="categoria">
			    ...
			    <?php
								...
								<option value = "<?php echo $row['idc'];?>">
											<?php echo $row['designacao']; ?> </option>
											<?php } ?>
...
<?php
    if((isset($_POST["nomep"])) && (isset($_POST["quantidade"])) && (isset($_POST["precounidade"])) && (isset($_POST["categoria"])))
    {
        
        $fnome = $_POST["nomep"];
        $fquantidade = $_POST["quantidade"];
        $fprecounidade = $_POST["precounidade"];
		$fcategoria = $_POST["categoria"];
     
       
        
        $query = mysqli_query($link, "insert into produtos(nomep,quantidade,precounidade,categoria) values ('$fnome', '$fquantidade','$fprecounidade','$fcategoria')");
