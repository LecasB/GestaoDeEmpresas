    ...
    <body class="app">
            ...
            <ul class="border-t border-theme-24 py-5 hidden">
                <li>
                    <a href="admin.php" class="menu menu--active">
                        ...
                        <div class="menu__title"> MenuGestão </div>
                    </a>
                </li>
                <li>
                    ...
                    <ul class="">
                        ...
                        <li>
                            <a href="top-menu-dark-dashboard.html" class="menu">
                                <div class="menu__icon"> <i data-feather="activity"></i> </div>
                                <div class="menu__title"> Apagar Empresa </div>
                            </a>
                        </li>
                    </ul>
                </li>
        ...
        <div class="flex">
            ...
            <div class="content">
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Aplicação</a> <i data-feather="fast-forward" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Dashboard</a> </div>
                    <!-- END: Breadcrumb -->
                        ...
                        <div class="dropdown-box w-56">
                            <div class="dropdown-box__content box bg-theme-38 dark:bg-dark-6 text-white">
                                <div class="p-4 border-b border-theme-40 dark:border-dark-3">
                                    ...
                                    <div class="text-xs text-theme-41 dark:text-gray
									-600">Aluno</div>
                                </div>
                                <div class="p-2">

                                    <a href="alterarpass.php" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="lock" class="w-4 h-4 mr-2"></i> Reset Password </a>
                                  
                                </div>
                                <div class="p-2 border-t border-theme-40 dark:border-dark-3">
                                    <a href="logout.php" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="toggle-right" class="w-4 h-4 mr-2"></i> Logout </a>
                                </div>
                            </div>
                        </div>
                    </div>
...
?>
                                            ...
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $i;?></div>
                                            <div class="text-base text-gray-600 mt-1">Total de Empresas:</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $i1;?></div>
                                            <div class="text-base text-gray-600 mt-1">Total de Fornecedores</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $i2;?></div>
                                            <div class="text-base text-gray-600 mt-1">Total de Localidades</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $i3;?></div>
                                            <div class="text-base text-gray-600 mt-1">Total de Produtos</div>
                                        </div>
                                    </div>
                                </div>
<div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $i4;?></div>
                                            <div class="text-base text-gray-600 mt-1">Total de Categorias</div>
                                        </div>
                                    </div>
                                </div>
								<div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $i5;?></div>
                                            <div class="text-base text-gray-600 mt-1">Total de Clientes</div>
                                        </div>
                                    </div>
                                </div>
							...
							<br> <br>
							<a href="" class="intro-x w-full block text-center rounded-md py-3 border border-dotted border-theme-15 dark:border-dark-5 text-theme-16 dark:text-gray-600">Listar Clientes Por Localidades</a>

<?php
$i9=0;
$query = "SELECT * FROM clientes where localidade like 'Cantanhede'";
$result = mysqli_query($link, $query);
while($row = mysqli_fetch_array($result)){
$i9++;
}
...
<?php
$i8=0;
$query = "SELECT * FROM clientes where localidade like 'Figueira'";
$result = mysqli_query($link, $query);
while($row = mysqli_fetch_array($result)){
$i8++;
}
...
<?php
$i7=0;
$query = "SELECT * FROM clientes where localidade like 'Mira'";
$result = mysqli_query($link, $query);
while($row = mysqli_fetch_array($result)){
$i7++;
}
...
<?php
$i6=0;
$query = "SELECT * FROM clientes where localidade like 'Carapinheira'";
$result = mysqli_query($link, $query);
while($row = mysqli_fetch_array($result)){
$i6++;
}
 ...
 <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $i9;?></div>
                                            <div class="text-base text-gray-600 mt-1">Clientes Cantanhede</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $i8;?></div>
                                            <div class="text-base text-gray-600 mt-1">Clientes Figueira</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $i7;?></div>
                                            <div class="text-base text-gray-600 mt-1">Clientes Mira</div>
                                        </div>
                                    </div>
                                </div>
<div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5">
                                            ...
                                            <div class="text-3xl font-bold leading-8 mt-6"><?php echo $i6;?></div>
                                            <div class="text-base text-gray-600 mt-1">Clientes Carapinheira</div>
                                        </div>
                                    </div>
                                </div>
                        </div>
