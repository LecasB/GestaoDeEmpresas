						...
						<div class="intro-y box  ">
                            <div class="intro-y flex items-center h-10">
                                <h2 class="text-lg font-medium truncate mr-5">
                                    ...
                                    Inserir Fornecedor: <i data-feather="edit-3"></i>
                                </h2>
...
<form name ="form_ins_prod" id="Form_ins_prod" action="InserirFornecedor.php" method="post">

<div class="mt-3"> <label>Nome:</label>  <input type="text" name="nomef" class="input w-full rounded-full border mt-2" placeholder="">  </div>
...
<div class="mt-3"> <label>Empresa:</label> <div class="mt-2"> <select class="input border mr-2" name="empresa">
...
<?php
    if((isset($_POST["nomef"])) && (isset($_POST["email"])) && (isset($_POST["telefone"])) && (isset($_POST["localidade"])) && (isset($_POST["empresa"])))
    {
        ...
        $query = mysqli_query($link, "insert into fornecedores(nomef,email,telefone,localidade,empresa) values ('$fnome', '$femail','$ftelefone','$flocalidade','$fempresa')");
