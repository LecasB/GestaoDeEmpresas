        ...
        <div class="flex">
            ...
            <div class="content">
				...
				<div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
							...
							<form name = "apagar_prod" id = "apagar_prod" action = "RemoverCategoria.php" method ="post" >
                            <div class="p-5" id="input">
                                <div class="preview">
							<div align = "left"> <b> Escolha a Categoria que pretende remover:							    
                                ...
                                <div class="preview">
                                    <div class="flex flex-col sm:flex-row items-center">
                                        <div class="sm:mt-2">
											...
											<?php
											$qry = "Select * from categorias order by idc";
						...
						$query = mysqli_query($link,"delete from categorias where idc = '$fprodid'");
