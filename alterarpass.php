...
?>
    ...
    action="formalterarpass.php"  method="post">
            ...
            value="<?php echo$fiduser?>"type="hidden"size="20"/>
                            ...
                            <div class="p-5">
                                <div>
                                    <label>Id</label>
                                    <input name="fid2"value="<?php echo$campo1?>" type="text" class="input w-full border mt-2" placeholder="">
                                </div>
                                <div class="mt-3">
                                    <label>Utilizador</label>
                                    <input name="fuser"value="<?php echo$campo2?>" type="text" class="input w-full border mt-2" placeholder="Utilizador">
                                </div>
                                <div class="mt-3">
                                    <label>Nova Password</label>
                                    <input name="fpass"value="<?php echo$campo3?>" type="password" class="input w-full border mt-2" placeholder="Nova Password">
                                </div>
                                <button meta http-equiv="refresh" content="0;url=formalterarpass.php"type="submit" class="button bg-theme-1 text-white mt-4">Alterar Password</button>
                            </div>
