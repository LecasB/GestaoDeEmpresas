                        ...
                        <div class="dropdown-box w-56">
                            <div class="dropdown-box__content box bg-theme-38 dark:bg-dark-6 text-white">
                                <div class="p-4 border-b border-theme-40 dark:border-dark-3">
                                    ...
                                    <div class="text-xs text-theme-41 dark:text-gray-600">Aluno</div>
                                </div>
                                <div class="p-2">
						...
						<div class="intro-y box  ">
                            <div class="intro-y flex items-center h-10">
                                <h2 class="text-lg font-medium truncate mr-5">
                                    ...
                                    Inserir Empresa: <i data-feather="edit-3"></i>
                                </h2>
...
<form name ="form_ins_prod" id="Form_ins_prod" action="InserirEmpresa.php" method="post">

<div class="mt-3"> <label>Nome</label>  <input type="text" name="nome" class="input w-full rounded-full border mt-2" placeholder=""> </div>
...
<div class="mt-3"> <label>Site</label> <div class="relative">
     <div class="absolute rounded-l w-10 h-full flex items-center justify-center bg-gray-100 dark:bg-dark-1 dark:border-dark-4 border text-gray-600">http</div> <input type="text" class="input pl-12 w-full border col-span-4" name="site" placeholder="">
 </div>
...
<div class="mt-3"> <label>Observações</label> <textarea  class="input w-full rounded-full border mt-2" name="observacoes" placeholder=""> </textarea> </div> <br>
...
<?php
    if((isset($_POST["nome"])) && (isset($_POST["telefone"])) && (isset($_POST["email"])) && (isset($_POST["site"])) && (isset($_POST["localidade"])) && (isset($_POST["observacoes"])))
    {
        ...
        $query = mysqli_query($link, "insert into empresas(Nome,Telefone,Email,Site, Localidade, Observacoes) values ('$fnome', $ftelefone, '$femail', '$fsite', '$flocalidade' , '$fobservacoes')");
