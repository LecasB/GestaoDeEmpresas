           ...
           <?php 
            ...
            <div class="content">
				...
				<div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
							...
							<form name = "apagar_prod" id = "apagar_prod" action = "RemoverLocalidade.php" method ="post" >
                            <div class="p-5" id="input">
                                <div class="preview">
							<div align = "left"> <b> Escolha a Localidade que pretende remover:							    
							<div class="p-5" id="select-options">
                                <div class="preview">
                                    <div class="flex flex-col sm:flex-row items-center">
                                        <div class="sm:mt-2">
                                            <select name ="id" class="input input--sm border mr-2">
											<?php
											$qry = "Select * from localidade ";
							...
							<button class="button bg-theme-1 text-white mt-5"> Apagar </button>
							</div>
							</form>
						<?php
						...
						$query = mysqli_query($link,"delete from empresas where ID = '$fprodid'");
						
						if ($query){
								echo " Apagado com sucesso.";
						}else{
								echo "Erro ao Apagar! Erro:".mysql_error()."";
						}
						}
						?>
                        </div>
