        ...
        <div class="flex">
            ...
            <div class="content">
				...
				<div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
							...
							<form name = "apagar_prod" id = "apagar_prod" action = "RemoverProduto.php" method ="post" >
                                ...
                                <div class="preview">
                                    <div class="flex flex-col sm:flex-row items-center">
                                        <div class="sm:mt-2">
											...
											<?php
											$qry = "Select * from produtos order by idp";
											$result = mysqli_query($link,$qry);
											while ($row = mysqli_fetch_array($result))
											{
											?>
											<option value = "<?php echo $row['idp'];?>">
											<?php echo $row['nomep']; ?> </option>
											<?php } ?>
                                            </select>
                                        </div>
									</div>
						...
						$query = mysqli_query($link,"delete from fornecedores where idcp = '$fprodid'");
