						...
						<div class="intro-y box  ">
                            <div class="intro-y flex items-center h-10">
                                <h2 class="text-lg font-medium truncate mr-5">
                                    ...
                                    Inserir Categoria: <i data-feather="edit-3"></i>
                                </h2>
...
<form name ="form_ins_prod" id="Form_ins_prod" action="InserirUtilizador.php" method="post">

<div class="mt-3"> <label>Utilizador:</label>  <input type="text" name="user" class="input w-full rounded-full border mt-2" placeholder="">  </div>
<div class="mt-3"> <label>Password:</label>  <input type="password" name="pass" class="input w-full rounded-full border mt-2" placeholder="">  </div>
<br>
<br>
...
<?php
    if(isset($_POST["user"]) && (isset($_POST["pass"])))
    {
        ...
        $query = mysqli_query($link, "insert into utilizadores(user,pass) values ('$fuser' , '$fpass')");
