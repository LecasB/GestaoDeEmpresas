        ...
        <div class="flex">
            ...
            <div class="content">
				...
				<div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
							...
							<form name = "apagar_prod" id = "apagar_prod" action = "ListarEmpresa.php" method ="post" >
                            
							<div class="p-5" id="input">
                                <div class="preview">
							<div align = "left"> <b> Escolha a Localidade das Empresas que quer Listar:							    
							...
							<button class="button bg-theme-1 text-white mt-5" type="submit">  Listar </button>
							</div>
							</form>
            ...
            <table class="table table-report -mt-2">
						   ...
						   <?php
						   $id = $_POST['id'];
                                $query = "SELECT * FROM empresas WHERE Localidade like '$id' ";
