						...
						<div class="intro-y box  ">
                            <div class="intro-y flex items-center h-10">
                                <h2 class="text-lg font-medium truncate mr-5">
                                    ...
                                    Inserir Cliente: <i data-feather="edit-3"></i>
                                </h2>
...
<form name ="form_ins_prod" id="Form_ins_prod" action="InserirCliente.php" method="post">
<div class="mt-3"> <label>BI:</label>  <input type="text" name="bi" class="input w-full rounded-full border mt-2" placeholder="">  </div>
<div class="mt-3"> <label>NIF:</label>  <input type="text" name="nif" class="input w-full rounded-full border mt-2" placeholder="">  </div>
<div class="mt-3"> <label>Nome:</label>  <input type="text" name="nomec" class="input w-full rounded-full border mt-2" placeholder="">  </div>
<div class="mt-3"> <label>Email</label> <div class="relative">
     <div class="absolute rounded-l w-10 h-full flex items-center justify-center bg-gray-100 dark:bg-dark-1 dark:border-dark-4 border text-gray-600">@</div> <input type="email" class="input pl-12 w-full border col-span-4" name="email" placeholder="">
 </div>
<div class="mt-3"> <label>Telefone:</label>  <input type="text" name="telefone" class="input w-full rounded-full border mt-2" placeholder="">  </div>
<div class="mt-3"> <label>Localidade:</label> <div class="mt-2"> <select class="input border mr-2" name="localidade">
			    ...
			    <?php
                                ...
                                {    
                                ?>
								<option value = "<?php echo $row['localidade'];?>">
											<?php echo $row['localidade']; ?> </option>
											<?php } ?>
								
         </select> </div> </div> 
 <br>  
                                            
<button type="submit" class="button w-24 rounded-full mr-1 mb-2 bg-gray-200 text-gray-600">Inserir</button> 
<button type="reset" class="button w-24 rounded-full mr-1 mb-2 border text-gray-700 dark:border-dark-5 dark:text-gray-300">Limpar</button> 
...
<?php
    if((isset($_POST["bi"])) && (isset($_POST["nif"])) && (isset($_POST["nomec"])) && (isset($_POST["email"])) && (isset($_POST["telefone"])) && (isset($_POST["localidade"])))
    {
        ...
        $query = mysqli_query($link, "insert into clientes(BI,NIF,nomec,email,telefone,localidade) values ('$fbi', '$fnif','$fnome','$femail','$ftelefone','$flocalidade')");
