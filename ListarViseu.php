...
<html lang="en" class="dark">
        ...
        <div class="flex">
            ...
            <nav class="side-nav">
                <a href="" class="intro-x flex items-center pl-5 pt-4">
                    <img alt="Midone Tailwind HTML Admin Template" class="w-6" src="dist/images/logo.svg">
                    <span class="hidden xl:block text-white text-lg ml-3"> <span class="font-medium">ETPC</span> </span>
                </a>
                ...
                <ul>
                    <li>
                        <a href="side-menu-dark-dashboard.html" class="side-menu side-menu--active">
                            ...
                            <div class="side-menu__title"> MenuGestão </div>
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="">
                            <li>
                                <a href="InserirEmpresa.php" class="side-menu">
                            ...
                            <li>
								...
								<ul>
								<a href="ListarAveiro.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="user-check"></i> </div>
                                    <div class="side-menu__title"> Aveiro </div>
									</a>
								<a href="ListarCantanhede.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="user-check"></i> </div>
                                    <div class="side-menu__title"> Cantanhede </div> 
									</a>
							<a href="ListarCoimbra.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="user-check"></i> </div>
                                    <div class="side-menu__title"> Coimbra </div> 
									</a>
									<a href="ListarFigueira.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="user-check"></i> </div>
                                    <div class="side-menu__title"> Figueira </div> 
									</a>
									<a href="ListarMira.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="user-check"></i> </div>
                                    <div class="side-menu__title"> Mira </div> 
									</a>
									<a href="ListarViseu.php" class="side-menu">
                                    <div class="side-menu__icon"> <i data-feather="user-check"></i> </div>
                                    <div class="side-menu__title"> Viseu </div> 
									</a>
									</ul>
                    ...
                    <li>
                        <a href="javascript:;" class="side-menu">
                            <div class="side-menu__icon"> <i data-feather="align-right"></i> </div>
    ...
    <body>
	<br>
	<h2><b> Listar Empresas Viseu: </b></h2>
    <h3><p class="intro-y text-lg font-medium mt-10"> </p></h3>
            <br />
        <?php include "DBConnection.php";  ?>
            ...
            <table class="table table-report -mt-2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center whitespace-no-wrap">Site</th>
                                    <th class="text-center whitespace-no-wrap">Local</th>
									<th class="text-center whitespace-no-wrap">Observações</th>
                                </tr>
                            </thead>
                           <tbody>
                           <?php
                                $query = "SELECT * FROM empresas WHERE Localidade like 'Viseu' ";
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            ...
                                            <a class="flex items-center text-theme-6" href="javascript:;" data-toggle="modal" data-target="#delete-confirmation-modal"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Remover </a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
            ...
            <br />
        <!--<button class="button button--lg w-full xl:w-32 text-white bg-theme-1 xl:mr-3 align-top"><a href="admin.php">Página Inicial</button>-->
