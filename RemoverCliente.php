        ...
        <div class="flex">
            ...
            <div class="content">
				...
				<div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
							...
							<form name = "apagar_prod" id = "apagar_prod" action = "RemoverCliente.php" method ="post" >
                            <div class="p-5" id="input">
                                <div class="preview">
							<div align = "left"> <b> Escolha o Cliente que pretende remover:							    
						...
						$query = mysqli_query($link,"delete from clientes where idc = '$fprodid'");
