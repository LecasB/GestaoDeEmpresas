        ...
        <div class="flex">
            ...
            <div class="content">
				...
				<div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
							...
							<form name = "apagar_prod" id = "apagar_prod" action = "RemoverUtilizador.php" method ="post" >
						...
						$query = mysqli_query($link,"delete from utilizadores where id = '$fprodid'");
